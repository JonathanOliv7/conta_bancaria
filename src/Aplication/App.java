...
//Coleta de dados para criar conta:
...
//Depositando valor a conta do usuário:		
		System.out.print("Enter a deposit value: ");
		money = sc.nextDouble();
		client.addValue(money);
//Mostrando dados atualizados para o usuário:			
		System.out.println("Update account: ");
		System.out.println(client.ToString());
//Sacando valor da conta do usuário:			
		System.out.print("Enther a withdraw value: ");
		money = sc.nextDouble();
		client.removeValue(money);
//Mostrando dados atualizados para o usuário:
		System.out.println("Update account: ");
		System.out.println(client.ToString());
		sc.close();
